...
export default function Navbar() {
  ...
  return (
    <nav className="h-16 bg-white border-b border-border px-4 flex items-center justify-between sticky top-0 z-40">
      ...
      {/* Right: Notifications + Connect Wallet */}
      <div className="flex items-center gap-3">
        ...
        <button
          className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 border border-primary text-primary rounded-lg text-sm font-medium hover:bg-primary-light transition-colors"
